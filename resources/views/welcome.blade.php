                        ...
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="top-middle">
                                <ul class="useful-links">
                                    ...
                                    <li><a href="{{ route('editorial.index') }}">Editorial</a></li>
                                    @endif
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <ul class="user-login">
                                        <li>
                                            <div class="user">
                                                ...
                                                <a href ="{{ route('dashboard') }}">Hello {{ Auth::user()->name }}</a>
                                            </div>
                                        </li>
                                    </ul>
                                @else
                        ...
                        <div class="nav-inner">
                            ...
                            <div class="mega-category-menu">
                                ...
                                <ul class="sub-category">
                                    ...
                                    <li><a href="product-grids.html">Dashboard Audio & Theater</a></li>
                                    <li><a href="product-grids.html">Computers & Tablets </a></li>
                                    <li><a href="product-grids.html">Video Games </a></li>
                                    <li><a href="product-grids.html">Dashboard Appliances </a></li>
                                </ul>
                            </div>
                            ...
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                    <ul id="nav" class="navbar-nav ms-auto">
                                        <li class="nav-item">
                                            <a href="{{ route('dashboard') }}" class="active" aria-label="Toggle navigation">Dashboard</a>
                                        </li>
                                        <li class="nav-item">
